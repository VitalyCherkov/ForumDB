...
RUN echo "effective_cache_size=300MB" >> /etc/postgresql/$PG_VERSION/main/postgresql.conf
RUN echo "checkpoint_segments=125MB" >> /etc/postgresql/$PG_VERSION/main/postgresql.conf
